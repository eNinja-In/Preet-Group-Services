        ...
        <div className="w-full h-fit bg-gray-100">
            <div className="w-full p-1">
                <div className="w-full max-h-fit min-h-full flex flex-wrap mb-1  border-b-2 border-gray-400 list-none">
                    ...
                    <Link className="min-w-[18%]" to="Reports"><Btn title="PDI Analysis" /></Link>
                    <Link className="min-w-[18%]" to="add-Data"><Btn title="Add Combine" /></Link>
                    <Link className="min-w-[18%]" to="combines-Data"><Btn title="Combines Data" /></Link>
